          ...
          <div className="container">
            <div className="gallery-main">
                <div className="upper-four">
                  ...
                  <img src={process.env.PUBLIC_URL + '../images/All.png'} alt="outdoor" />
                  <img src={process.env.PUBLIC_URL + '../images/Cooperate.png'} alt="popular" />
                  <img src={process.env.PUBLIC_URL + '../images/Customised.png'} alt="limited" />
                </div>
